// -*- verilog -*-
// tb_particle_scorer_oct_arb_60beam.v — tb_particle_scorer_oct_arb.v와 동일 구조,
// 실제 ZERO 빔 개수(60)로 8파티클 동시처리 latency를 재는 변형(p60_0..7 정답지
// 사용, gen_particle_scorer_60beam_test.py). RTL은 그대로(재합성 불필요) —
// NUM_RAYS/파일명만 다름.
//
//   iverilog -o sim/tb_particle_scorer_oct_arb_60beam.vvp rtl/ray_march_edt.v rtl/addr_gen.v rtl/table_mem.v rtl/sensor_pe.v rtl/arbiter8.v rtl/particle_scorer_arb.v rtl/particle_scorer_oct_arb.v tb/tb_particle_scorer_oct_arb_60beam.v
//   cd sim && vvp tb_particle_scorer_oct_arb_60beam.vvp

`timescale 1ns/1ps

module tb_particle_scorer_oct_arb_60beam;
    ...
    initial begin
        $readmemh("p60_0_dx.hex", dxs0); $readmemh("p60_0_dy.hex", dys0); $readmemh("p60_0_r.hex", rs0); $readmemh("p60_0_x0y0.hex", xy0); $readmemh("p60_0_expected.hex", exp0);
        $readmemh("p60_1_dx.hex", dxs1); $readmemh("p60_1_dy.hex", dys1); $readmemh("p60_1_r.hex", rs1); $readmemh("p60_1_x0y0.hex", xy1); $readmemh("p60_1_expected.hex", exp1);
        $readmemh("p60_2_dx.hex", dxs2); $readmemh("p60_2_dy.hex", dys2); $readmemh("p60_2_r.hex", rs2); $readmemh("p60_2_x0y0.hex", xy2); $readmemh("p60_2_expected.hex", exp2);
        $readmemh("p60_3_dx.hex", dxs3); $readmemh("p60_3_dy.hex", dys3); $readmemh("p60_3_r.hex", rs3); $readmemh("p60_3_x0y0.hex", xy3); $readmemh("p60_3_expected.hex", exp3);
        $readmemh("p60_4_dx.hex", dxs4); $readmemh("p60_4_dy.hex", dys4); $readmemh("p60_4_r.hex", rs4); $readmemh("p60_4_x0y0.hex", xy4); $readmemh("p60_4_expected.hex", exp4);
        $readmemh("p60_5_dx.hex", dxs5); $readmemh("p60_5_dy.hex", dys5); $readmemh("p60_5_r.hex", rs5); $readmemh("p60_5_x0y0.hex", xy5); $readmemh("p60_5_expected.hex", exp5);
        $readmemh("p60_6_dx.hex", dxs6); $readmemh("p60_6_dy.hex", dys6); $readmemh("p60_6_r.hex", rs6); $readmemh("p60_6_x0y0.hex", xy6); $readmemh("p60_6_expected.hex", exp6);
        $readmemh("p60_7_dx.hex", dxs7); $readmemh("p60_7_dy.hex", dys7); $readmemh("p60_7_r.hex", rs7); $readmemh("p60_7_x0y0.hex", xy7); $readmemh("p60_7_expected.hex", exp7);
    end
